  ...
  return (
    <>
      ...
      >
        <Modal.Content maxWidth="350">
          <Modal.CloseButton />
          <Modal.Header><Text style={{ textAlign: "center", fontSize: 18,marginTop:20 }}>
              {selectedName} is {selectedFees} EGP
            </Text></Modal.Header>
          <Modal.Body>
            {/* <Text style={{ textAlign: "center", fontSize: 18 }}> */}
              <PaymentComponent setClosePay = {setShowModal2}></PaymentComponent>
            {/* </Text> */}
          </Modal.Body>
        </Modal.Content>
      </Modal>
